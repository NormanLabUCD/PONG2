...
> reference panel in the KIR region (chr19:54,600,000–55,200,000 for hg38;
> chr19:55,000,000–55,400,000 for hg19).
>
...
> ⚠️ **Important:** `--vcf` is the **only input** required with `--fill-missing`.  
